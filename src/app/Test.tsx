...
export default function Test() {
    ...
    const fetchApiData = async () => {
        ...
        for (let i = 1; i <= 10; i++){
            const response = await axios.get(`https://kopis.or.kr/openApi/restful/pblprfr?service=ffb2e5d6f87f41ca9e2a3314ff44adad&stdate=20230401&eddate=20230430&cpage=${i}&rows=10&signgucode=11&signgucodesub=1111`);
